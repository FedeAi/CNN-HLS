...
//
//
//    FILE* flatten_content = fopen("/home/federico/CLionProjects/cnn-xilinx/flatten_py.out","r");
...
//    }
//
//    FILE* fc_content = fopen("/home/federico/CLionProjects/cnn-xilinx/fc_py.out","r");
//    if(fc_content == NULL)
//    {
...
//
//    FILE* conv_content = fopen("/home/federico/CLionProjects/cnn-xilinx/conv_py.out","r");
...
//    }
//
//    FILE* pool_content = fopen("/home/federico/CLionProjects/cnn-xilinx/pool_py.out","r");
...
//        out>>conv_out[i];
    ...
    FILE* conv_content = fopen("/home/federico/CLionProjects/cnn-xilinx/conv_t_py.out","r");
    if(conv_content == NULL)
    {
        printf("Couldn't open ../../../../ref/conv_py.out");
        exit(1);
